			...
			<div class="row">
				<div class="col-md-7">
					...
					<div class="row mt-3 pl-3 pr-3">
						<div class="input-tags">
							...
							<img src="<?php echo plugin_dir_url( __FILE__ ) . 'images/outline-label-24px.svg'; ?>">
						</div>
				...
				<div class="col-md-5">
					<div class="row border-b ml-3 mr-3">
						...
						<img src="<?php echo plugin_dir_url( __FILE__ ) . 'images/outline-delete-24px.svg'; ?>" class="float-right opacity-5">
						<img src="<?php echo plugin_dir_url( __FILE__ ) . 'images/outline-label-24px.svg'; ?>" class="float-right mr-2 opacity-5">
					</div>
				...
				<div class="col-md-6">
					<table>
						<tr>
							...
							<td><img src="<?php echo plugin_dir_url( __FILE__ ) . 'images/green.png'; ?>" width=='20' height='25'> 84 / 81</td>
							<td><input type="checkbox" name="" class="lc-switch"></td>
						</tr>
						<tr>
							<td><i class="glyphicon socicon-yahoo" style="font-size: 20px;"></i> Yahoo</td>
							<td><img src="<?php echo plugin_dir_url( __FILE__ ) . 'images/red.png'; ?>" width=='20' height='25'> 84 / 81</td>
							<td><input type="checkbox" name="" class="lc-switch"></td>
						</tr>
						<tr>
							<td><i class="glyphicon socicon-bing" style="font-size: 20px;"></i> Bing</td>
							<td><img src="<?php echo plugin_dir_url( __FILE__ ) . 'images/yellow.png'; ?>" width=='20' height='25'> 84 / 81</td>
							<td><input type="checkbox" name="" class="lc-switch"></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2">
								...
								<img src="<?php echo plugin_dir_url( __FILE__ ) . 'images/green.png'; ?>" class='ml-2' width=='20' height='25'>
							</td>
							<td><input type="checkbox" name="" class="lc-switch"></td>
						</tr>
						<tr>
