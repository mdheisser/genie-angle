(function (angular) {
    ...
    angular
        ...
        .controller('websitePagesController', websitePagesController)

    websitePagesController.$inject = ['$scope', '$mdDialog', 'pagesService', 'convertPageDataFilter'];

    function websitePagesController($scope, $mdDialog, pagesService, convertPageDataFilter) {
