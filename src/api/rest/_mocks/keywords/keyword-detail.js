(function (server) {
    var payload = [
        ...
        {id: 5, pageUrl: 'http://www.umm.edu/health/medical/altmed/treatment/122', keywords: 4, category: {default: false, promoted:false, monitored: false, forced: false}, violate: 1, ranking: 1, significance: 2, suitability: 3, assignedState: false},
        {id: 6, pageUrl: 'http://www.umm.edu/health/medical/altmed/d', keywords: 4, category: {default: true, promoted:true, monitored: true, forced: true}, violate: 1, ranking: 2, significance: 3, suitability: 4, assignedState: false},
        {id: 7, pageUrl: 'http://www.umm.edu/login', keywords: 0, category: {default: false, promoted:false, monitored: false, forced: false}, violate: 1, ranking: 3, significance: 2, suitability: 1, assignedState: false},
        {id: 8, pageUrl: 'http://www.umm.edu/health/medical/altmed/treatment/herbal-medicine', keywords: 1, category: {default: true, promoted:true, monitored: true, forced: true}, violate: 1, ranking: 4, significance: 2, suitability: 3, assignedState: false}
    ];
