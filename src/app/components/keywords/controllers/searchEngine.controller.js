(function (angular) {
    ...
    angular
        ...
        .controller("searchEngineCtrl", searchEngineCtrl);
    searchEngineCtrl.$inject = ['$scope', 'websitesService', '$timeout'];

    function searchEngineCtrl($scope, websitesService, $timeout) {
        var vm = this;
        vm.seViews = [];
        vm.searchEngines = [];
        vm.domains = [];
